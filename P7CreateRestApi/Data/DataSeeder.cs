...
namespace Dot.Net.WebApi.Data
{
    ...
    public static class DataSeeder
    {
        ...
        public static async Task SeedAdminRoles(UserManager<User> userManager, RoleManager<IdentityRole> roleManager, ILogger<LogApiCallAspect> logger)
        {
            ...
            else
            {
                ...
                {
                    logger.LogCritical($"- {error.Description}");
                }
            }
        }
    }
